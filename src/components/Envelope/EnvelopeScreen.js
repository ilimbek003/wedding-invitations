...
const EnvelopeScreen = ({ onOpen }) => {
  const [phase, setPhase] = useState('idle') // idle | zoom | done
  ...
  return (
    <div className={`env-page ${phase}`}>
      ...
      {/* ── Creamy linen background texture ── */}
      <div className="env-bg" />

      {/* ── Cherub logo — top right ── */}
      ...
      <div className="env-scene" onClick={handleClick}>
        <div className="env-wrapper">
          ...
          <div className="env-body">
            ...
            {/* ── Right triangle (slightly different shade) ── */}
              ...
              <div className="env-seal">
                ...
                <div className="seal-disc">
                  ...
                  <svg className="seal-crest" viewBox="0 0 180 200" fill="none">
                    ...
                    {/* Top ornament crown */}
                    <path d="M70 18 Q90 5 110 18 Q100 12 90 14 Q80 12 70 18Z"
                      fill="rgba(170,130,30,0.8)"/>
                    <path d="M80 8 Q90 2 100 8 L98 15 Q90 10 82 15Z"
                      fill="rgba(160,120,20,0.7)"/>
                    {/* Crown points */}
                    ...
                    <path d="M55 188 Q70 200 90 198 Q110 200 125 188"
                      fill="none" stroke="rgba(160,120,20,0.7)" strokeWidth="2"/>
                    ...
                    <path d="M42 175 Q36 185 40 192 Q44 188 46 180Z" fill="rgba(160,120,20,0.5)"/>
                    <path d="M138 175 Q144 185 140 192 Q136 188 134 180Z" fill="rgba(160,120,20,0.5)"/>

                    {/* Oval inner ring */}
                    <ellipse cx="90" cy="108" rx="52" ry="62" fill="none"
                      stroke="rgba(170,130,30,0.45)" strokeWidth="1.5"/>
                  </svg>
